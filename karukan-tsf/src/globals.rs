...
#[cfg(target_os = "windows")]
pub const CLSID_KARUKAN_TEXT_SERVICE: GUID = GUID::from_u128(
    0xA7E3_F1B2_4C8D_4F2E_9A1B_6D3E_5F7C_8A90,
);
...
#[cfg(target_os = "windows")]
pub const GUID_KARUKAN_PROFILE: GUID = GUID::from_u128(
    0xB8F4_E2C3_5D9A_4E3F_8B2C_7E4F_6A8D_9B01,
);
...
#[cfg(target_os = "windows")]
pub const GUID_DISPLAY_ATTRIBUTE_INPUT: GUID = GUID::from_u128(
    0xC9A5_D3E4_6EAB_4F40_9C3D_8F5A_7B9E_AC12,
);
...
#[cfg(target_os = "windows")]
pub const GUID_DISPLAY_ATTRIBUTE_CONVERTED: GUID = GUID::from_u128(
...
#[cfg(target_os = "windows")]
pub static DLL_REF_COUNT: std::sync::atomic::AtomicUsize =
