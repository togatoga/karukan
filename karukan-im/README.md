...
- ローマ字入力によるひらがな変換（Google IME互換の200以上のルール）
...
> **Note**: モデル推論だけでは語彙が限られるため、システム辞書の併用を強く推奨します。システム辞書はIMEに同梱されていないため、別途ビルドが必要です。詳しくは [karukan-cli の README](../karukan-cli/README.md) を参照してください。
